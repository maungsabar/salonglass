        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h4 className="font-serif text-sm font-semibold tracking-wider text-gold-400 uppercase">Navigasi</h4>
              <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs text-salon-cream/70 font-light">
                <Link href="/" className="hover:text-gold-400 transition-colors">Beranda</Link>
                <span className="text-gold-500/30">|</span>
                <Link href="/catalog" className="hover:text-gold-400 transition-colors">Katalog Ready</Link>
                <span className="text-gold-500/30">|</span>
                <Link href="/custom" className="hover:text-gold-400 transition-colors">Custom Cabinet</Link>
                <span className="text-gold-500/30">|</span>
